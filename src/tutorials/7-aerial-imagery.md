...
In the next cell of your notebook copy the following script, and run it. It defines a function to download aerial images based on input parameters, that it then transforms into an API Query, which is essentially a URL.::
