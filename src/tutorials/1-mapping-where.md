---
title: "Mapping Where: Seeing the Forest and the Trees"
date: "2022-01-19"
...
- [New York City Landcover 2010 (3ft version)](https://data.cityofnewyork.us/Environment/Landcover-Raster-Data-2010-3ft-Resolution/9auy-76zt). A raster dataset created to describe major land use categories for New York City derived from satellite imagery. Download this dataset (Land Cover 2010.zip) and unzip its contents. You should have a folder titled `Land_Cover_2010` with five files in it. Also from the above page download the Data Dictionary for this dataset: `Landcover2010_DataDictionary_20171012.xlsx`. Save it within the `Land_Cover_2010` folder. 
...
![qgis interface](/tutorials/images/151/01-qgis-interface.png#img-full)
...
![land cover dataset rendered](/tutorials/images/151/05-land-cover.png)
...
![measuring tool demo](/tutorials/images/151/08-landuse-measure.png#img-full)
...
![tree canopy map](/tutorials/images/151/10-tree-canopy.png#img-full)
...
![add street trees from xy locations](/tutorials/images/151/12-street-trees.png)
...
![field calculator](/tutorials/images/151/21-field-calc.png)
...
![field calculator results](/tutorials/images/151/22-field-calc.png)
...
![graduated symbols menu](/tutorials/images/151/25-tree-size.png)

Your map should look something like this:

![graduated trees map](/tutorials/images/151/26-tree-size.png)

## Assignment 0
Design a map, or a series of maps showing your ***Views of NYC Trees***. This is an opportunity to experiment with the nuances between these different ways of representing (and indeed understanding) trees in New York City.  Complete the [next short module](https://centerforspatialresearch.github.io/methods-in-spatial-research-sp2024/tutorials/print-layout) on the print layout functions of QGIS cartographic design before embarking on this.
