...
Download the `landsat_sample.zip` compressed file from [here](https://drive.google.com/open?id=1mLN1xMDg6cx8JypO87zce5-Af3AF86kp&usp=drive_fs). This contains a clipped version of two landsat band sets showing the North West side of Puerto Rico before and after Hurricane Maria. They have been clipped to speed up processing times.

Unzip the file and save the folder within the `data`>`original` directory you have for this sequence.  
