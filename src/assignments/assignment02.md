...
- Select one of the map examples discussed thus far during class (look back at lecture slides and/or examples from [precedents page](../resources/precedents-examples) and imitate some aspect of its graphic style when designing the map of digitized features. This is the best way to learn and practice designing beautiful maps.
