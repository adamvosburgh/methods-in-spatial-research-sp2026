...
- As you design your map choose one of the projects we have looked at thus far in class as a visual precedent (see slides posted on Canvas, examples on Miro boards, as well as the precedents page [here](../tutorials/precedents-examples)), and imitate some aspect of its graphic style.
